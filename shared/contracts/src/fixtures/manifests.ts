/**
 * Manifestos das 7 unidades da BASE inicial do catálogo (doc 33, seção 5).
 * Cada um é um BlockManifest neutro válido contra BlockManifestSchema.
 * A IMPLEMENTAÇÃO dos componentes é T-I/F0.4 — aqui é só o CONTRATO.
 */
import type { BlockManifest } from '../types';

export const kpiManifest = {
  type: 'kpi',
  kind: 'chart',
  name: 'KPI',
