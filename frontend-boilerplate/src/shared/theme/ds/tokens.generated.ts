...
export const dsColorTokens: Record<string, DsTokenValue> = {
  ...
  '--ds-color-border-nav-sidebar': duo(
...
export const dsShadowTokens: Record<string, DsTokenValue> = {
  ...
  '--ds-shadow-card':
    '0 0 2px 0 var(--ds-shadow-tint-0_2), 0 12px 24px -4px var(--ds-shadow-tint-0_12)',
  '--ds-shadow-dropdown':
    '0 0 2px 0 var(--ds-shadow-tint-0_24), -20px 20px 40px -4px var(--ds-shadow-tint-0_24)',
  ...
  '--ds-elevation-0': 'none',
  '--ds-elevation-1':
    '0px 2px 1px -1px var(--ds-shadow-tint-0_2),0px 1px 1px 0px var(--ds-shadow-tint-0_14),0px 1px 3px 0px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-2':
    '0px 3px 1px -2px var(--ds-shadow-tint-0_2),0px 2px 2px 0px var(--ds-shadow-tint-0_14),0px 1px 5px 0px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-3':
    '0px 3px 3px -2px var(--ds-shadow-tint-0_2),0px 3px 4px 0px var(--ds-shadow-tint-0_14),0px 1px 8px 0px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-4':
    '0px 2px 4px -1px var(--ds-shadow-tint-0_2),0px 4px 5px 0px var(--ds-shadow-tint-0_14),0px 1px 10px 0px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-5':
    '0px 3px 5px -1px var(--ds-shadow-tint-0_2),0px 5px 8px 0px var(--ds-shadow-tint-0_14),0px 1px 14px 0px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-6':
    '0px 3px 5px -1px var(--ds-shadow-tint-0_2),0px 6px 10px 0px var(--ds-shadow-tint-0_14),0px 1px 18px 0px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-7':
    '0px 4px 5px -2px var(--ds-shadow-tint-0_2),0px 7px 10px 1px var(--ds-shadow-tint-0_14),0px 2px 16px 1px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-8':
    '0px 5px 5px -3px var(--ds-shadow-tint-0_2),0px 8px 10px 1px var(--ds-shadow-tint-0_14),0px 3px 14px 2px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-9':
    '0px 5px 6px -3px var(--ds-shadow-tint-0_2),0px 9px 12px 1px var(--ds-shadow-tint-0_14),0px 3px 16px 2px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-10':
    '0px 6px 6px -3px var(--ds-shadow-tint-0_2),0px 10px 14px 1px var(--ds-shadow-tint-0_14),0px 4px 18px 3px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-11':
    '0px 6px 7px -4px var(--ds-shadow-tint-0_2),0px 11px 15px 1px var(--ds-shadow-tint-0_14),0px 4px 20px 3px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-12':
    '0px 7px 8px -4px var(--ds-shadow-tint-0_2),0px 12px 17px 2px var(--ds-shadow-tint-0_14),0px 5px 22px 4px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-13':
    '0px 7px 8px -4px var(--ds-shadow-tint-0_2),0px 13px 19px 2px var(--ds-shadow-tint-0_14),0px 5px 24px 4px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-14':
    '0px 7px 9px -4px var(--ds-shadow-tint-0_2),0px 14px 21px 2px var(--ds-shadow-tint-0_14),0px 5px 26px 4px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-15':
    '0px 8px 9px -5px var(--ds-shadow-tint-0_2),0px 15px 22px 2px var(--ds-shadow-tint-0_14),0px 6px 28px 5px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-16':
    '0px 8px 10px -5px var(--ds-shadow-tint-0_2),0px 16px 24px 2px var(--ds-shadow-tint-0_14),0px 6px 30px 5px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-17':
    '0px 8px 11px -5px var(--ds-shadow-tint-0_2),0px 17px 26px 2px var(--ds-shadow-tint-0_14),0px 6px 32px 5px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-18':
    '0px 9px 11px -5px var(--ds-shadow-tint-0_2),0px 18px 28px 2px var(--ds-shadow-tint-0_14),0px 7px 34px 6px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-19':
    '0px 9px 12px -6px var(--ds-shadow-tint-0_2),0px 19px 29px 2px var(--ds-shadow-tint-0_14),0px 7px 36px 6px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-20':
    '0px 10px 13px -6px var(--ds-shadow-tint-0_2),0px 20px 31px 3px var(--ds-shadow-tint-0_14),0px 8px 38px 7px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-21':
    '0px 10px 13px -6px var(--ds-shadow-tint-0_2),0px 21px 33px 3px var(--ds-shadow-tint-0_14),0px 8px 40px 7px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-22':
    '0px 10px 14px -6px var(--ds-shadow-tint-0_2),0px 22px 35px 3px var(--ds-shadow-tint-0_14),0px 8px 42px 7px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-23':
    '0px 11px 14px -7px var(--ds-shadow-tint-0_2),0px 23px 36px 3px var(--ds-shadow-tint-0_14),0px 9px 44px 8px var(--ds-shadow-tint-0_12)',
  '--ds-elevation-24':
    '0px 11px 15px -7px var(--ds-shadow-tint-0_2),0px 24px 38px 3px var(--ds-shadow-tint-0_14),0px 9px 46px 8px var(--ds-shadow-tint-0_12)',
};
...
export const dsTokenProvenance: Readonly<Record<string, string>> = {
  ...
  '--ds-color-border-input-disabled':
    'frontend/src/theme/core/components/textfield.tsx:65',
  '--ds-color-border-button-outlined-inherit':
    'frontend/src/theme/core/components/button.tsx:125',
  '--ds-color-border-nav-sidebar': 'frontend/src/layouts/dashboard/css-vars.ts:40',
  '--ds-color-border-toggle-group':
    'frontend/src/theme/core/components/button-toggle.tsx:82',
  '--ds-color-border-pagination-outlined':
    'frontend/src/theme/core/components/pagination.tsx:103',
};

export const dsMeta = {
  project: 'AuditorIA — frontend',
  generatedFrom:
    'tema MUI 7.0.1 computado em Node + medicoes em runtime (Chrome, viewport 1911x898)',
  ...
  remBase: {
    value: '14px',
    warning:
      'CRITICO: html { font-size: 14px }. Todo valor em rem renderiza a rem x 14. Os rem do tema foram gerados com divisor 16.',
  },
  colorSyntax:
    'O projeto emite rgba(R G B / A) (CSS Color 4). Cada token traz tambem a forma rgba(R, G, B, A).',
