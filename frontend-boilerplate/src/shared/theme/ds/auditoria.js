...
/**
 * auditoria theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { auditoriaTheme } from './auditoria';
 *   import './auditoria.css';
 */
export const auditoriaTheme = {
  name: 'auditoria',
  __built: true,
  tokens: {
    ...
    '--ds-color-text-primary': 'light-dark(#1C252E, #FFFFFF)',
    '--ds-color-text-secondary': 'light-dark(#637381, #919EAB)',
    '--ds-color-text-disabled': 'light-dark(#919EAB, #637381)',
    '--ds-color-background-default': 'light-dark(#FFFFFF, #141A21)',
    '--ds-color-background-paper': 'light-dark(#FFFFFF, #1C252E)',
    '--ds-color-background-neutral': 'light-dark(#F4F6F8, #28323D)',
    ...
    '--ds-color-action-active': 'light-dark(#637381, #919EAB)',
    ...
    '--ds-color-border-nav-sidebar':
      'light-dark(rgba(145 158 171 / 0.12), rgba(145 158 171 / 0.08))',
    '--ds-color-border-toggle-group': 'rgba(145 158 171 / 0.08)',
    '--ds-color-border-pagination-outlined': 'rgba(145 158 171 / 0.24)',
    '--ds-shadow-tint-0_12': 'light-dark(rgba(145 158 171 / 0.12), rgba(0 0 0 / 0.12))',
    '--ds-shadow-tint-0_14': 'light-dark(rgba(145 158 171 / 0.14), rgba(0 0 0 / 0.14))',
    '--ds-shadow-tint-0_16': 'light-dark(rgba(145 158 171 / 0.16), rgba(0 0 0 / 0.16))',
    '--ds-shadow-tint-0_2': 'light-dark(rgba(145 158 171 / 0.2), rgba(0 0 0 / 0.2))',
    '--ds-shadow-tint-0_24': 'light-dark(rgba(145 158 171 / 0.24), rgba(0 0 0 / 0.24))',
    ...
    '--color-on-accent': 'var(--ds-color-primary-contrast-text)',
    '--color-text-accent':
      'light-dark(var(--ds-color-primary-main), var(--ds-color-primary-light))',
    '--color-icon-accent':
      'light-dark(var(--ds-color-primary-main), var(--ds-color-primary-light))',
    '--color-accent-muted': 'rgba(var(--ds-channel-primary-main) / 0.16)',
    '--color-background-body': 'var(--ds-color-background-default)',
    '--color-background-card': 'var(--ds-color-background-paper)',
    '--color-background-popover': 'var(--ds-color-background-paper)',
    '--color-background-surface': 'var(--ds-color-background-paper)',
    '--color-background-muted': 'var(--ds-color-background-neutral)',
    ...
    '--color-icon-primary': 'var(--ds-color-text-primary)',
    '--color-icon-secondary': 'var(--ds-color-action-active)',
    '--color-icon-disabled': 'var(--ds-color-text-disabled)',
    '--color-border': 'var(--ds-color-divider)',
    '--color-border-emphasized': 'var(--ds-color-border-button-outlined-inherit)',
    '--color-overlay-hover': 'var(--ds-color-action-hover)',
    '--color-overlay-pressed': 'var(--ds-color-action-selected)',
    '--color-neutral': 'var(--ds-color-action-hover)',
    '--color-on-dark': 'var(--ds-color-common-white)',
    '--color-on-light': 'var(--ds-color-grey-800)',
    '--color-on-success': 'var(--ds-color-success-contrast-text)',
    '--color-on-error': 'var(--ds-color-error-contrast-text)',
    '--color-on-warning': 'var(--ds-color-warning-contrast-text)',
    '--color-skeleton': 'var(--ds-color-grey-400)',
    '--color-tint-hover':
      'light-dark(var(--ds-color-common-black), var(--ds-color-common-white))',
    '--color-success':
      'light-dark(var(--ds-color-success-darker), var(--ds-color-success-lighter))',
    '--color-success-muted':
      'light-dark(var(--ds-color-success-lighter), var(--ds-color-success-darker))',
    '--color-warning':
      'light-dark(var(--ds-color-warning-darker), var(--ds-color-warning-lighter))',
    '--color-warning-muted':
      'light-dark(var(--ds-color-warning-lighter), var(--ds-color-warning-darker))',
    '--color-error':
      'light-dark(var(--ds-color-error-darker), var(--ds-color-error-lighter))',
    '--color-error-muted':
      'light-dark(var(--ds-color-error-lighter), var(--ds-color-error-darker))',
    '--color-background-gray': 'var(--ds-color-background-neutral)',
    '--color-border-gray': 'var(--ds-color-divider)',
    '--color-icon-gray': 'var(--ds-color-text-secondary)',
    '--color-text-gray': 'var(--ds-color-text-primary)',
    '--color-background-red':
      'light-dark(var(--ds-color-error-lighter), var(--ds-color-error-darker))',
    '--color-border-red':
      'light-dark(var(--ds-color-error-light), var(--ds-color-error-dark))',
    '--color-icon-red':
      'light-dark(var(--ds-color-error-dark), var(--ds-color-error-light))',
    '--color-text-red':
      'light-dark(var(--ds-color-error-darker), var(--ds-color-error-lighter))',
    ...
    '--color-background-orange':
      'light-dark(var(--ds-color-warning-lighter), var(--ds-color-warning-darker))',
    '--color-border-orange':
      'light-dark(var(--ds-color-warning-light), var(--ds-color-warning-dark))',
    '--color-icon-orange':
      'light-dark(var(--ds-color-warning-dark), var(--ds-color-warning-light))',
    '--color-text-orange':
      'light-dark(var(--ds-color-warning-darker), var(--ds-color-warning-lighter))',
    ...
    '--color-background-green':
      'light-dark(var(--ds-color-success-lighter), var(--ds-color-success-darker))',
    '--color-border-green':
      'light-dark(var(--ds-color-success-light), var(--ds-color-success-dark))',
    '--color-icon-green':
      'light-dark(var(--ds-color-success-dark), var(--ds-color-success-light))',
    '--color-text-green':
      'light-dark(var(--ds-color-success-darker), var(--ds-color-success-lighter))',
    '--color-background-teal':
      'light-dark(var(--ds-color-primary-lighter), var(--ds-color-primary-darker))',
    '--color-border-teal':
      'light-dark(var(--ds-color-primary-light), var(--ds-color-primary-dark))',
    '--color-icon-teal':
      'light-dark(var(--ds-color-primary-dark), var(--ds-color-primary-light))',
    '--color-text-teal':
      'light-dark(var(--ds-color-primary-darker), var(--ds-color-primary-lighter))',
    '--color-background-cyan':
      'light-dark(var(--ds-color-info-lighter), var(--ds-color-info-darker))',
    '--color-border-cyan':
      'light-dark(var(--ds-color-info-light), var(--ds-color-info-dark))',
    '--color-icon-cyan':
      'light-dark(var(--ds-color-info-dark), var(--ds-color-info-light))',
    '--color-text-cyan':
      'light-dark(var(--ds-color-info-darker), var(--ds-color-info-lighter))',
    ...
    '--color-background-purple':
      'light-dark(var(--ds-color-secondary-lighter), var(--ds-color-secondary-darker))',
    '--color-border-purple':
      'light-dark(var(--ds-color-secondary-light), var(--ds-color-secondary-dark))',
    '--color-icon-purple':
      'light-dark(var(--ds-color-secondary-dark), var(--ds-color-secondary-light))',
    '--color-text-purple':
      'light-dark(var(--ds-color-secondary-darker), var(--ds-color-secondary-lighter))',
    '--color-shadow': 'rgba(var(--ds-channel-grey-500) / 0.16)',
    '--shadow-low': 'var(--ds-shadow-z1)',
    '--shadow-med': 'var(--ds-shadow-card)',
    '--shadow-high': 'var(--ds-shadow-dropdown)',
    '--shadow-inset-hover': 'inset 0 0 0 2px rgba(var(--ds-channel-primary-main) / 0.24)',
    '--shadow-inset-selected':
      'inset 0 0 0 2px rgba(var(--ds-channel-primary-main) / 0.48)',
    '--shadow-inset-success':
      'inset 0 0 0 2px rgba(var(--ds-channel-success-main) / 0.24)',
    '--shadow-inset-warning':
      'inset 0 0 0 2px rgba(var(--ds-channel-warning-main) / 0.24)',
    '--shadow-inset-error': 'inset 0 0 0 2px rgba(var(--ds-channel-error-main) / 0.24)',
    '--ds-focus-ring-width': '2px',
    '--ds-focus-ring-offset': '2px',
    '--ds-focus-ring-color': 'var(--color-accent)',
    '--radius-none': '0px',
    '--radius-inner': '6px',
    '--radius-element': '8px',
    ...
    '--radius-full': '9999px',
    '--ds-radius-chip': '10px',
    '--ds-radius-avatar': '12px',
    '--duration-fast-min': '150ms',
    '--duration-fast': '200ms',
    '--duration-fast-max': '250ms',
    ...
    '--ds-easing-out': 'cubic-bezier(0.0, 0, 0.2, 1)',
    '--ds-easing-in': 'cubic-bezier(0.4, 0, 1, 1)',
    '--ds-easing-sharp': 'cubic-bezier(0.4, 0, 0.6, 1)',
    '--ds-layout-transition-duration': '120ms',
    '--ds-layout-transition-easing': 'linear',
    '--font-size-4xs': '10.5px',
    '--font-size-3xs': '11.375px',
    '--font-size-2xs': '12.25px',
    '--font-size-xs': '13.125px',
    '--font-size-sm': '14px',
    '--font-size-base': '14.875px',
    '--font-size-lg': '15.75px',
    '--font-size-xl': '17.5px',
    '--font-size-2xl': '21px',
    '--font-size-3xl': '28px',
    '--font-size-4xl': '35px',
    ...
    '--text-heading-1-size': '35px',
    '--text-heading-1-weight': '800',
    '--text-heading-1-leading': '1.25',
    '--text-heading-2-size': '28px',
    '--text-heading-2-weight': '800',
    '--text-heading-2-leading': '1.3333333333333333',
    '--text-heading-3-size': '21px',
    '--text-heading-3-weight': '700',
    '--text-heading-3-leading': '1.5',
    '--text-heading-4-size': '17.5px',
    '--text-heading-4-weight': '700',
    '--text-heading-4-leading': '1.5',
    '--text-heading-5-size': '15.75px',
    '--text-heading-5-weight': '700',
    '--text-heading-5-leading': '1.5',
    '--text-heading-6-size': '14.875px',
    '--text-heading-6-weight': '600',
    '--text-heading-6-leading': '1.5555555555555556',
    '--text-body-size': '14px',
    '--text-body-weight': '400',
    '--text-body-leading': '1.5',
    '--text-supporting-size': '12.25px',
    '--text-supporting-weight': '400',
    '--text-supporting-leading': '1.5714285714285714',
    '--text-label-size': '12.25px',
    '--text-label-weight': '600',
    '--text-label-leading': '1.5714285714285714',
    '--text-large-size': '14px',
    '--text-large-weight': '600',
    '--text-large-leading': '1.5',
    '--text-code-size': '12.25px',
    '--text-code-weight': '400',
    '--text-code-leading': '1.5714285714285714',
    '--text-display-1-size': '35px',
    '--text-display-1-weight': '800',
    '--text-display-1-leading': '1.25',
    '--text-display-2-size': '28px',
    '--text-display-2-weight': '800',
    '--text-display-2-leading': '1.3333333333333333',
    '--text-display-3-size': '21px',
