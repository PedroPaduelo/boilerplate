...
const CLUSTERS: ClusterSpec[] = [
  {
    ...
    leaves: 38,
    subs: [
      { label: 'Vale Engenharia', leaves: 19 },
      { label: 'Vale Incorporações', leaves: 12 },
    ],
  },
  {
    ...
    hubValue: 6_180_000,
    leaves: 46,
    subs: [{ label: 'Bom Preço Atacado', leaves: 17 }],
  },
  {
    grupo: 'Serviços',
    code: 'SER',
    ...
    hubValue: 4_760_000,
    leaves: 25,
    subs: [{ label: 'Ápice Facilities', leaves: 14 }],
  },
  {
    grupo: 'Indústria',
    code: 'IND',
    ...
    leaves: 32,
    subs: [
      { label: 'Norte Fundição', leaves: 13 },
      { label: 'Norte Logística', leaves: 9 },
    ],
  },
  {
    grupo: 'Transporte',
    ...
    hubValue: 3_950_000,
    leaves: 28,
    subs: [{ label: 'Litoral Frotas', leaves: 11 }],
  },
  {
    grupo: 'Saúde',
    code: 'SAU',
    ...
    hubValue: 2_840_000,
    leaves: 21,
    subs: [{ label: 'Central Diagnósticos', leaves: 9 }],
  },
  {
    grupo: 'Agronegócio',
    code: 'AGR',
    ...
    hubValue: 5_270_000,
    leaves: 34,
    subs: [{ label: 'Serra Insumos', leaves: 13 }],
  },
  {
    grupo: 'Tecnologia',
    code: 'TEC',
