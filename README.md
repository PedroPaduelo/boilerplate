...
| **Dashboards** | Composição de gráficos em linhas/blocos, com filtros. Também em `draft`/`published`, com hidratação de dados em lote e atualização por Socket.IO. Aceita ainda **relatórios externos**: painéis feitos fora da plataforma entram na mesma lista e abrem no endereço original ([doc](frontend-boilerplate/docs/dashboards/RELATORIOS-EXTERNOS.md)). |
